...
/*
	...
	This program creates an Ordered Set with the use of linked lists
	and also have functions for set such as union, intersection, and
	difference.
*/
...
/*
	This a struct where it will represent nodes in a linked list
	containing the data and the pointer to the next node. 
*/
typedef struct Set{
	int n;
	struct Set *pointer;
...
/*
	This function sorts the list to ascending order.
*/
void sort(Set *a){
	Set *sets = a;
	int counter = 0;
...
/*
	This function inserts new value e in Set a and 
	return the pointer to the first element of a.
*/
Set *add(Set *a,int e){
	Set *tail;
	Set *b;	
...
/*
	This function merges elements from sets s1 and s2
	and returns a new Ordered Set.
*/
...
/*
	This function returns a new Ordered Set that contains
	common elements from sets s1 and s2.
*/
...
/*
	This function returns a new Ordered Set that contains
	unique elements found in s1 that is not found in s2.
*/
...
/*
	This function prints and displays the elements in the 
	Ordered Set. 
*/
void print(Set *a){
	Set *sets = a;
